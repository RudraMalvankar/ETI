...
def run_test():
    ...
    for inc in incidents:
        ...
        print(f"Shadow Simulation completed (ID: {sim_id}). Scenarios generated: {len(sim_data['scenarios'])}")
        ...
        if decision['supporting_citations']:
            print(f"Citations: {len(decision['supporting_citations'])} retrieved document chunks validated.")
        else:
