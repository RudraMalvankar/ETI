...
export const SettingsPage: React.FC = () => {
  const { apiBaseUrl, connectionState, isDarkMode, toggleTheme } = useApexStore();
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <SectionCard title="AI Guardrail & Confidence Parameters" subtitle="Decision Engine Hallucination Thresholds">
          <div className="space-y-4 text-xs">
            <div>
              <label className="block text-slate-400 font-semibold mb-1">Minimum Citation Confidence Threshold</label>
              <input
                type="range"
                min="50"
                max="99"
              ...
              />
              <span className="text-[10px] text-slate-500 mt-1 block">Requires minimum 85% citation similarity score</span>
            </div>
