...
export const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center rounded-2xl bg-red-950/20 border border-red-500/20 backdrop-blur-md" role="alert">
